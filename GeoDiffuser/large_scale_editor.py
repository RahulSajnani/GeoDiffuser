...
def perform_exp(exp_dict, prompt = "", ldm_stable_model = None, tokenizer_model = None, scheduler_in = None, 
    ...
    if edit_type == "geometry_editor":
        ...
        loss_weights_dict = {"self": {"sim": 55, "movement": 30.5, "removal": 1.6, "smoothness": 30.0, "amodal": 80.5},
                                "cross": {"sim": 45, "movement": 30.34, "removal": 1.6, "smoothness": 15.0, "amodal": 3.5}}
...
if __name__=="__main__":
    ...
    exp_root_folder = "/oscar/scratch/rsajnani/rsajnani/research/2023/test_sd/test_sd/prompt-to-prompt/ui_outputs/large_scale_study_optimizer_sd_test"
    ...
    # # exp_folder = "./ui_outputs/teasers/Mix/1/"
    # exp_folder = "./ui_outputs/large_scale_study_all/large_scale_study_final/Translation_2D/24/"
    ...
    if check_if_exp_root(exp_root_folder):
        ...
        for f in root_folders_list:
            ...
            exp_cat = f.split("/")[-2]
            # if exp_cat == "Removal" or exp_cat == "Rotation_2D" or exp_cat == "Mix":
