    ...
    with gr.Tab(label="Editing Real Image"):
        ...
        with gr.Row(visible=True) as movement_options:
            ...
            with gr.Column():
                ...
                obj_edit_step = gr.Slider(label='Diffusion Correction',
                            info='Diffusion Correction',
                            minimum=0,
                            maximum=1,
                            step=0.01,
                            value=0.9)
